...
var connToken = "90932530|-31949277348960259|90949219";
        $('#studentrollno').focus();
...
var getRequest = createGET_BY_KEYRequest(connToken,
 StudentDBName, studentRelationName , studentrollnoJsonObj);
...
jsonStr0bj, StudentDBName, studentRelationName);
jQuery.ajaxSetup({async: false});
...
jsonupdate, StudentDBName, studentRelationName,localStorage.getItem('recno'));
jQuery.ajaxSetup({async: false});
